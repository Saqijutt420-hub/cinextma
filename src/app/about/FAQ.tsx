  ...
  const faqs = [
    {
      ...
      description:
        "Just like every other website, Fmovies is also a streaming site that helps to easily access all the TV shows and movies we wanted, without spending hours searching for them.",
    },
    {
